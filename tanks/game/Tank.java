...
public class Tank extends GameObject {
	...
	public final static double STARTING_MOVE_SPEED = 2.5;   // units per second original 2.5
	public final static double STARTING_TURN_SPEED = 90;	// degrees per second original 90
